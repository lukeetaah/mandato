...
const provinceEconomy = (overrides = {}) => ({
    gdp: 50,
    employment: 50,
    poverty: 40,
    investment: 40,
...
export const HOUSING_PERCEPTION = {
    monoambiente: 12,
    ph: 8,
    departamento: 2,
    'casa-barrio': 0,
...
export function createDefaultReputation() {
    return {
        'empresarios': 40,
        'trabajadores': 50,
        'jovenes': 55,
